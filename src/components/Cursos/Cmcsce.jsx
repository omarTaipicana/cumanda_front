    ...
    return (
        <div className="cmcsce_page">
            ...
            <section className="cmcsce_hero">
                ...
                <div className="cmcsce_intro">
                    <div className="cmcsce_intro_content">
                        <span className="cmcsce_label">CUMANDA · Curso Internacional</span>
                        ...
                        <p className="cmcsce_subtitle">
                            Desarrollar competencias integrales en la identificación, manejo y resolución de conflictos sociales y crisis emocionales, mediante la aplicación de estrategias de negociación, comunicación asertiva
                        </p>
                ...
                <div className="cmcsce_floating_panels">
                    <div className="cmcsce_pdf_panel" ref={containerRef}>
                        <div className="cmcsce_panel_head">
                            ...
                            <div className="cmcsce_panel_title">
                                Brochure del curso
                            </div>
                        </div>
                    ...
                    <div className="cmcsce_info_panel">
                        ...
                        <h3 className="cmcsce_title">
                            Curso de Manejo de Conflictos Sociales y Crisis Emocionales            </h3>

                        <p className="cmcsce_description">
                            Desarrollar competencias integrales en la identificación, manejo y resolución de conflictos sociales y crisis emocionales, mediante la aplicación de estrategias de negociación, comunicación asertiva            </p>
